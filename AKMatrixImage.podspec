#
#  Be sure to run `pod spec lint AKMatrixImage.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   Relying on the current best picture loading framework, 
  ...
  s.author             = { "ZuoCaiSong" => "ZuoCaiSong@163.com" }
  # Or just: s.author    = ""
  # s.authors            = { "" => "" }
